...
// Plain anchors (#section) and query strings do not make a different page, and neither does
// naming a folder's index file (/index.html is /).
function routeOf(href, base) {
  ...
  return `${target.pathname.replace(/\/index\.html?$/i, '/')}${target.hash.startsWith('#/') ? target.hash : ''}`;
}
