...
export function pageProgress(project, page) {
  ...
  return { status: pageStatus(page, completion), ...completion, scanProblems: scanProblems(page.scan), changedSinceReview: changedSinceReview(page) };
}
...
export function addFeatures(projectId, pageId, features, by) {
  assertCount(features, 'Features to add', 1, 20);
  return updatePage(projectId, pageId, page => {
...
export function recordScan(projectId, pageId, input) {
  ...
  page.scan = { scannedAt, sourceUrl, actor: page.captures.desktop.actor, captureSha256, viewports, changes };
