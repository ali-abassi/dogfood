...
export async function runVisualReview(dataDir, project, page) {
  const capture = reviewableCapture(dataDir, page.captures.desktop);
...
function reviewRecord(page, capture, raw, analysis, started) {
  return {
    ...
    request: { instruction, pageName: page.name, sourceUrl: page.captures.desktop.sourceUrl, schema, imageSha256: capture.sha256 },
    response: raw,
  };
}
